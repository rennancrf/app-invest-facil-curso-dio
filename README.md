...
A ferramenta Invest Fácil realiza uma simulação de aplicação de investimentos em Fundos Imobiliários (FIIs) de acordo com o perfil de invertidor do usuário.

## Utilização da ferramenta

Para realizar a simulação de aplicação de investimentos, é necessário que o usuário realize o preenchimento dos seguintes blocos:

### 1- Informações do Investidor
...
Neste bloco o usuário seleciona qual o seu perfil de investidor, podendo escolher entre:
- Conservador:
  - Prioriza a segurança e a estabilidade do capital acima de grandes rentabilidades.
  - Tolerância ao risco baixa. Prefere ativos de renda fixa que não sofrem oscilações bruscas. 
- Moderado:
  - Busca um equilíbrio entre a segurança da renda fixa e o crescimento da rentabilidade.
  - Tolerância ao risco média. Aceita enfrentar certa volatilidade (oscilações) em parte da sua carteira de investimentos.
- Agressivo:
